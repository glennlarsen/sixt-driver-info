...
import SendDriverInfo4 from "utils/SendDriverInfo4";
...
function DriverInformation4({ title, confirmation }) {
  ...
  async function onSubmit(data) {
    setLoading(true);
    const send = await SendDriverInfo4(data);
    if (send.success) {
      setTimeout(() => {
        setLoading(false);
        setLang("en");
...
export default DriverInformation4;

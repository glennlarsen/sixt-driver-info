...
import DeleteDriver4 from "utils/DeleteDriver4";
...
function AnswersForm4({ title }) {
  ...
  const url = BASE_URL + DRIVERFORM4;
  ...
  async function handleDelete(id) {
    const deleteDriv = await DeleteDriver4(id);
